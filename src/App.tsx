...
import { formatRelativeTime, formatDate } from "customMain/utils/dateHelpers";
...
export default function App() {
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <Card className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-4 bg-green-700">🔗 Shared Redux Counter</h2>
